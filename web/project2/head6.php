...
?>
  ...
  <link rel="stylesheet" href="/css/sub6-common.css">
  <link rel="stylesheet" href="/css/sub6-1-index.css">
...
<header id="header">
  <div class="inner">
    ...
    <ul class="gnb">
      ...
      <li class="depth1"><a href="/sub/sub6-1.php">멤버십</a>
        <ul class="depth2">
...
<main id="main">
  ...
  <section class="visual">
    <div class="inner">
      <p class="visual-txt">팔공티 소식</p>
    </div>
  </section>
  <nav class="lnb">
    <div class="inner">
      <ul class="lnb-menu">
        <li class="lnb-menu1-current"><a href="http://lee-song-yi.pe.kr/bbs/board.php?bo_table=notice">공지사항</a></li>
        <li class="lnb-menu1-current"><a href="http://lee-song-yi.pe.kr/bbs/board.php?bo_table=event">이벤트</a></li>
        <li class="lnb-menu1-current"><a href="http://lee-song-yi.pe.kr/bbs/board.php?bo_table=news">NEWS</a></li>
      </ul>
    </div>
  </nav>
  <section class="palgongtea-member inner">