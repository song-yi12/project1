...
?>
  ...
  <link rel="stylesheet" href="/css/sub3-common.css">
  <link rel="stylesheet" href="/css/sub3-1-index.css">
  <link rel="stylesheet" href="/css/sub3-2-index.css">
  <link rel="stylesheet" href="/css/sub3-3-index.css">
...
<main id="main">
  ...
  <section class="visual">
    <div class="inner">
      <p class="visual-txt">창업문의</p>
    </div>
  </section>
  <nav class="lnb">
    <div class="inner">
      <ul class="lnb-menu">
        <li class="lnb-menu1-current"><a href="/sub/sub3-1.php">가맹절차</a></li>
        <li class="lnb-menu2-current"><a href="/sub/sub3-2.php">인테리어</a></li>
        <li class="lnb-menu3-current"><a href="/sub/sub3-3.php">가맹비용</a></li>
        <li class="lnb-menu4-current"><a href="http://lee-song-yi.pe.kr/bbs/board.php?bo_table=basic_qa">상담신청</a></li>
      </ul>
    </div>
  </nav>
  <section class="palgongtea-founded inner">