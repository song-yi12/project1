...
?>
  ...
  <link rel="stylesheet" href="/css/sub4-common.css">
...
<main id="main">
  ...
  <section class="visual">
    <div class="inner">
      <p class="visual-txt">매장 안내</p>
    </div>
  </section>
  <nav class="lnb">
    <div class="inner">
      <ul class="lnb-menu">
        <li class="lnb-menu1-current"><a href="http://lee-song-yi.pe.kr/bbs/board.php?bo_table=map">국내 매장</a></li>
        <li class="lnb-menu2-current"><a href="http://lee-song-yi.pe.kr/bbs/board.php?bo_table=global">해외 매장</a></li>
      </ul>
    </div>
  </nav>
