...
?>
<link rel="stylesheet" type="text/css" href="<?php echo $board_skin_url ?>/css/component.css" />
		 ...
		 <li>
			<figure>
				...
				<?php } else {
					...
					if($thumb['src']) {
						$img_content = '<img src="'.$thumb['src'].'" alt="'.$thumb['alt'].'" width="174" height="124">';
					} else {
				...
				<figcaption>
					...
					<a href="<?php echo $list[$i]['href'] ?>">Take a look</a>
				</figcaption>
			</figure>
		</li>
        <?php } ?>
