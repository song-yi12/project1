...
<h3 id="bo_btn_tit_global">KOREA MARKET</h3>
      <p>PALGONGTEA의 국내 지점 안내입니다.</p>
...
<!-- 게시판 검색 시작 { -->
      <h1 id="map-tit">매장찾기</h1>
<fieldset id="bo_sch">
	<h2 id="map-tit2">01. 주소/매장명 검색</h2>
