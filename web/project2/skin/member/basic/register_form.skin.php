	    ...
	    <div class="register_form_inner">
	        ...
	        <ul>
	            <li>
	                <label for="reg_mb_id">
	                    아이디 (필수)
	                    <button type="button" class="tooltip_icon"><span class="sound_only">설명보기</span></button>
...
gif, jpg, png파일만 가능하며 용량 <?php echo number_format($config['cf_member_icon_size']) ?>바이트 이하만 등록됩니다.</span>
	            ...
	            <li class="chk_box">
		            ...
		            <label for="reg_mb_mailling" id="reg_mb_mailling">
		            	<span id="reg_mb_mailling-chk"></span>
		        ...
		        <li class="chk_box">
		        	...
		        	<label for="reg_mb_sms" id="reg_mb_sms">
		            	<span></span>
		        ...
		        <li class="chk_box">
		            <input type="checkbox" name="mb_open" value="1" id="reg_mb_open" <?php echo ($w=='' || $member['mb_open'])?'checked':''; ?> class="selec_chk">
		      		<label for="reg_mb_open" id="reg_mb_open">
		      			<span id="reg_mb_open-chk"></span>
